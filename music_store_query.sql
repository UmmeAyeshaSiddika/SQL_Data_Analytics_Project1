...
--Q1.Write a query to return the email, first_name, last_name,
--and genre by all Rock music listeners. Return your list ordered 
...
--song length longer than the average song length. Return the Name and milliseconds
...
--Q1. Find how much about spent by each customer on artists? Write a query to 
...
GROUP BY 1,2,3,4
ORDER BY 5 DESC;
--Q.2 We want to find out the most popular music genre for each country. We determine the most 
